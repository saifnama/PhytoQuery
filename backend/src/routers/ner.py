"""NER Router — text/DOI extraction plus PDF-upload extraction (merged ex ner_pdf.py)."""
...
from backend.src.domain.schemas import NERRequest, NERResponse, Entity
from backend.src.papers.europe_pmc import EuropePMCService


# Dependency providers live in backend.src.dependencies.
...
# --- PDF upload NER (merged ex ner_pdf.py) ---
