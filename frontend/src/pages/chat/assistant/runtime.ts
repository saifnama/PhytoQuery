/**
 * assistant-ui ChatModelAdapter for the BloomIndex RAG backend.
 *
...
export interface BloomIndexRuntimeOptions {
...
export function useBloomIndexRuntime(opts: BloomIndexRuntimeOptions) {
...
/** Public so the parent (ChatPage's "Reset all" handler) can clear the
