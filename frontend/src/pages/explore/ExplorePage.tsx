...
import { FilterSidebarContext } from '@/features/search/FilterSidebarContext';
import { Skeleton } from '@/components/ui/skeleton';
import { nerApi } from '../../lib/api/papers';;
...
const Dashboard = lazy(() => import('@/features/search/Dashboard').then(m => ({ default: m.default })));
...
// ─── small UI atoms — co-located so ExplorePage stays a single file ─────────────
